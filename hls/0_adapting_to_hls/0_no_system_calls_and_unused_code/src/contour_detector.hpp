...
namespace motdet
{
    namespace imgutil
    {
         ...
         * @param conts The found contours along with it's hierarchy.
         ...
         */
        void contour_detection(Image<int> &in, std::vector<Motion_detector::Contour> &conts, bool trim_borders = true);
