...
namespace motdet
{
    namespace imgutil
    {
         ...
         * @param in Streamed image to resize, will use the sizes original_width and original_height. with packed pixels.
        ...
        /**
		 * @brief Gets the absolute difference between an image and the reference image, while updating it.
